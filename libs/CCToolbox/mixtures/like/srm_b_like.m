function [Lhood,other] = srm_b_like(varargin)
%SRM_B_LIKE  Calculate log-likelihood with SRM_B model.
%
%   [Lhood,Other] = SRM_B_LIKE(M,Trajs,[Options])
%    - M       : trained model
%    - Trajs   : 'Trajs' structure; See also CCTOOLBOX
%    - Options : see MODEL_LIKE
%
%   [Lhood,Other] = SRM_B_LIKE(M,X,Y,Seq,[Options])
%    - M       : trained model
