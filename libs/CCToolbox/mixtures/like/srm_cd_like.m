function [Lhood,other] = srm_cd_like(varargin)
%SRM_CD_LIKE  Calculate log-likelihood with SRM_CD model.
%
%   [Lhood,Other] = SRM_CD_LIKE(M,Trajs,[Options])
%    - M       : trained model
%    - Trajs   : 'Trajs' structure; See also CCTOOLBOX
%    - Options : see MODEL_LIKE
%
%   [Lhood,Other] = SRM_CD_LIKE(M,X,Y,Seq,[Options])
%    - M       : trained model
