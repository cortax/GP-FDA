function [Lhood,other] = srm_d_like(varargin)
%SRM_D_LIKE  Calculate log-likelihood with SRM_D model.
%
%   [Lhood,Other] = SRM_D_LIKE(M,Trajs,[Options])
%    - M       : trained model
%    - Trajs   : 'Trajs' structure; See also CCTOOLBOX
%    - Options : see MODEL_LIKE
%
%   [Lhood,Other] = SRM_D_LIKE(M,X,Y,Seq,[Options])
%    - M       : trained model
