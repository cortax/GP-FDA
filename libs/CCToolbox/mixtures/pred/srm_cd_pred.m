function [Yhat,Pmod] = srm_cd_pred(M,pt,x,Y,Seq,maxx)
%SRM_CD_PRED  Make a partial curve prediction with an SRM_CD model.
%
...
%
%   [Yhat,PostModel] = SRM_CD_PRED(M,pt,X,Y,Seq,['max'])
%    - M       : trained model
...
%
%   [[],PostModel] = SRM_CD_PRED(M,[],x,Y,Seq,['max'])
%    - M       : trained model
%    - pt      : must equal []
